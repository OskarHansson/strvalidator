...
#' entire dataset or grouped by one or multiple columns. Returns a data.frame
#' with the grouped columns, number of observations 'X.n', the minimum value
#' 'X.Min', the mean value 'X.Mean', standard deviation 'X.Stdv', and the
#' provided percentile 'X.Perc.##'.
