...
test_that("calculateDropout", {
  ...
  expect_that(calculateDropout(data=testSample, ref=ref4), gives_warning())
  ...
  # Warn that 'Height' was not numeric.
  expect_that(calculateDropout(data=testSample, ref=ref4, ignoreCase=FALSE), gives_warning())
  ...
  # Warn that 'Height' was not numeric.
  expect_that(calculateDropout(data=testSample, ref=ref4, ignoreCase=TRUE),
              gives_warning())
  ...
  # Warn that 'Height' was not numeric.
  expect_that(calculateDropout(data=testSample, ref=ref4, ignoreCase=FALSE),
              gives_warning())
